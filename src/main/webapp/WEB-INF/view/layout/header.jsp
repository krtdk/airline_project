...
<head>
	<meta charset="UTF-8">
	<title>항공사ㅣAirline Project</title>
	<link href="https://static.jejuair.net/hpgg/resources/images/icon/favicon.ico" rel="icon" type="image/png"/>
...
<div class="page--container">
	<header>
		...
		<nav>
			<img alt="" src="https://static.jejuair.net/cms/images/banner_image/20211014191229348.png" class="logo" onclick="location.href='/';">
