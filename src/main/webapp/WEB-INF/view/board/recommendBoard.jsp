				...
				<c:forEach var="board" items="${popularBoard}">
					<div class="popular--board--content">
						<div class="tr--boardList" data-toggle="modal" data-target="#modalDetail" id="boardDetail${board.id}" style="cursor: pointer;">
							<div class="td--img">
								<img src="<c:choose>
                                        <c:when test='${empty board.thumbnailImage()}'>
                                            <c:url value="https://static.jejuair.net/cms/images/banner_image/20211014191229348.png"/>
                                        </c:when>
                                        <c:otherwise>
                                            <c:url value='${board.thumbnailImage()}'/>
                                        </c:otherwise>
                                    </c:choose>" alt="" class="popular--img">
							</div>
							<div class="td--board">
						...
						<c:forEach var="board" items="${boardList}">
							<div class="tr--boardList" data-toggle="modal" data-target="#modalDetail" id="boardDetail${board.id}" style="cursor: pointer;">
								<div class="td--img">
                                    ...
                                    </c:choose>" alt="" class="popular--img">								</div>
								<div class="td--board">
